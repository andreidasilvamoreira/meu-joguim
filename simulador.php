...
class Simulador
{
    public function criar_exercito($tipo_unidades)
    {
        $exercito = [];
    ...
    public function batalhar($exercito1, $exercito2)
    {
        if (!empty($exercito1) && !empty($exercito2)) {
            ...
            $this->resultadoBatalha($exercito1, $exercito2);
        } else {
            echo "Precisa existir unidades no exercito!";
        }
    }

    private function empate($exercito1, $exercito2)
    {
        if (empty($exercito1) && empty($exercito2)) {
            return true;
        } else {
    ...
    private function resultadoBatalha($exercito1, $exercito2)
    {
        if ($this->empate($exercito1, $exercito2)) {
